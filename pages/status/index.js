...
function afficher(data) {
    ...
    for (let status of data) {
        ...
        pied.innerText = status.typeDeBois;
        ...
        lesStatus.appendChild(row);

        let objet = status.pId;
        button.onclick = () => {
            $.ajax({
